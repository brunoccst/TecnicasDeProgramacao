 ...
 * @author Bruno
 */
public class SeletorDeLog extends javax.swing.JFrame {

    public SeletorDeLog() {
        initComponents();
    }
    
    public void associaController(ImportarInserirController c){
        seletor.addActionListener(c);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeletorDeLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeletorDeLog().setVisible(true);
            }
        });
    }
